...
download_url="$download_url_prefix-unknown-linux-musl-noopt-20211017T1616.tar.zst" && [[ $(uname) == Windows_NT* ]] && download_url="$download_url_prefix-pc-windows-msvc-static-noopt-20211017T1616.tar.zst"
cpython_zip="$runtime_tools/cpython-linux.tar.zst" && [[ $(uname) == Windows_NT* ]] && cpython_zip="$runtime_tools/cpython-win.tar.zst"
