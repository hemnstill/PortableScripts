...
runtime_exe_relative_path=node && $is_windows_os && runtime_exe_relative_path=node.exe
runtime_version_name=node-v16.13.2 && $is_windows_os && runtime_version_name=node-v16.13.2-win-x64
